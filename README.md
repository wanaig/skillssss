...
**第 1 步：架构设计（必须最先执行）**
加载 `architecture/main_agent_prompt_fs_architect.md`，提供 PRD 路径。产出 8 份架构文档。
...
# Flutter（可选）
/flutter/main_agent_prompt_flutter.md
PROJECT_ROOT + REQUIREMENT_FILE + 架构文档路径

# 区块链（可选）
/blockchain/main_agent_prompt_blockchain.md
PROJECT_ROOT + REQUIREMENT_FILE + 架构文档路径
```
...
```
/fullstack/main_agent_prompt_fullstack.md
...
```
/deploy/main_agent_prompt_deploy.md
