...
## 全局架构图
                        ...
                        ┌──────────────────────────────────────┐
                        │       Phase -1: platform/intake     │
                        │       客户端需求采集（外包平台入口）   │
                        │                                       │
                        │  pf_intake 引导客户结构化描述需求     │
                        │                                       │
                        │  产出：prd.md (REQUIREMENT_FILE)     │
                        └──────────────┬───────────────────────┘
                                       │
                                       ▼
                        ┌──────────────────────────────────────┐
...
| 变量名 | 含义 | 来源 | 消费者 |
|--------|------|------|--------|
| `REQUIREMENT_FILE` | PRD 路径 | platform/intake → 用户 | 全部模块 |
| `PLATFORM_ROOT` | 平台项目根目录 | 用户 | platform |
