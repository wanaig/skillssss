...
| **Phase 1a** | `frontend/` | architecture 产出 | 可与 1b, 1c 并行 |
| **Phase 1b** | `backend/` | architecture 产出 | 可与 1a, 1c 并行 |
| **Phase 1c** | `flutter/` | architecture 产出 | 可与 1a, 1b 并行 |
...
| **Agent ID 收集** | 子Agent 完成后 ID 写入 `agent-registry.json` |
